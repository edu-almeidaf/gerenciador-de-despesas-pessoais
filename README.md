...
O frontend da aplicação foi desenvolvido com HTML, TailwindCSS e JavaScript e o backend foi simulado pela implementação de uma API Fake, usando o JSON Server.
